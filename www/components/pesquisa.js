    ...
    for (var i = 0; i < books.length; i++) {
        ...
        if (thumbnail) {
            ...
            bookElement.innerHTML = `
                ...
                <button class="about-button" data-title="${title}" data-authors="${authors}" data-publisher="${book.publisher}" data-description="${description}" data-preview-link="${book.previewLink}">Sobre</button>
            `;
